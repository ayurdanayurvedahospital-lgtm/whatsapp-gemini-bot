...
10. STRICT BREVITY & ZERO-PRESSURE SALES:
...
13. CUSTOMER PRODUCT OVERRIDE & CONTEXT SWITCHING:
...
15. DELIVERY, SHIPPING & WORLDWIDE POLICY:
...
- FOR GAIN PLUS (Appetite Focus):
  ...
  * USAGE (STRICT): If suggested alongside other weight gain products (Staamigen Malt, Sakhitone, or Staamigen Powder), the dosage is: 1 capsule half an hour BEFORE breakfast and dinner. If suggested alone, the dosage is: 2 capsules half an hour AFTER breakfast and dinner.
